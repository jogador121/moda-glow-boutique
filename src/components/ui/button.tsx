...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary-glow hover:scale-105 transition-bounce shadow-soft hover:shadow-elegant",
        destructive:
        ...
        luxury: "bg-luxury text-luxury-foreground hover:bg-luxury/90 shadow-luxury transition-smooth",
        hero: "bg-gradient-primary text-luxury font-semibold hover:scale-105 transition-bounce shadow-elegant hover:shadow-luxury",
      },
      size: {
